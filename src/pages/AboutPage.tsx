      ...
      <main className="flex-grow">
        ...
        <section className="bg-blog-primary text-white py-16 md:py-24">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-3xl md:text-5xl font-bold mb-4">عني</h1>
            <p className="text-xl max-w-2xl mx-auto opacity-90">
              مرحباً بك في مدونتي الرقمية، مساحتي الشخصية لمشاركة المعرفة والأفكار في مجالات متنوعة
            </p>
          </div>
        </section>
        ...
        <section className="py-12 md:py-16">
          <div className="container mx-auto px-4 max-w-4xl">
            <div className="mb-12 pb-6 border-b">
              <h2 className="text-2xl md:text-3xl font-bold mb-6">قصتي</h2>
              <p className="text-lg mb-4">
                بدأت مدونتي الرقمية كمشروع شخصي في عام 2023 برغبة في مشاركة المعرفة والتجارب في مجالات متعددة، 
              ...
              <p className="text-lg mb-4">
                ...
                كانت تفتقر إلى المحتوى العربي الجيد. أسعى دوماً لتقديم محتوى موثوق، مُدعم بالمصادر،
                ويضيف قيمة حقيقية للقارئ.
              </p>
              <p className="text-lg mb-4">
                أؤمن بأن المعرفة حق للجميع، وأن مشاركتها هي مسؤولية مجتمعية. لذا، أسعى لجعل جميع 
                محتوياتي سهلة الوصول ومفيدة لأكبر شريحة ممكنة من القراء.
              </p>
            </div>
            ...
            <div className="mb-12 pb-6 border-b">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-blog-muted p-6 rounded-lg">
                  <h3 className="text-xl font-bold mb-4">رؤيتي</h3>
                  <p>
                    أن أصبح مرجعاً موثوقاً للمعرفة في مجالات التقنية والتعليم وإدارة الأعمال والإنسانيات في المحتوى العربي.
                  </p>
                </div>
                <div className="bg-blog-muted p-6 rounded-lg">
                  <h3 className="text-xl font-bold mb-4">رسالتي</h3>
                  <p>
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold mb-6">تواصل معي</h2>
