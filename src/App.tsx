import { Toaster } from "@/components/ui/toaster";          // التنبيهات البسيطة (shadcn)
import AppToaster from "@/components/ui/sonner";            // التنبيهات الملوّنة (Sonner) ← صادرات default
