      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="mb-6 md:mb-0">
            <h2 className="text-xl font-bold mb-4">المدونة الرقمية</h2>
          ...
          <div className="mb-6 md:mb-0">
            ...
            <p className="text-gray-300">
              يمكنك متابعتنا على وسائل التواصل الاجتماعي أو مراسلتنا عبر البريد الإلكتروني.
            </p>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row md:justify-between text-center md:text-right">
          <div className="mb-2 md:mb-0">
            <p className="text-sm text-gray-400">&copy; {currentYear} المدونة الرقمية. جميع الحقوق محفوظة.</p>
          </div>
          <div className="flex justify-center md:justify-end">
            <Link to="/privacy" className="text-sm text-gray-400 hover:text-white ml-4">سياسة الخصوصية</Link>
            <Link to="/about" className="text-sm text-gray-400 hover:text-white">من نحن</Link>
          </div>
        </div>
      </div>
    </footer>
